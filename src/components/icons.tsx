...
export function FacebookIcon(props: SVGProps<SVGSVGElement>) {
 ...
 <path d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.33-.05-1.56-.14-2.86-.14C11.93 2 10 3.66 10 6.7v2.8H7v4h3V22h4v-8.5z" />
 </svg>
 )
}
...
export function TikTokIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path d="M16.5 3c.26 2.06 1.42 3.3 3.5 3.44v2.42c-1.2.12-2.26-.27-3.5-1.02v6.05c0 3.08-2.28 5.11-5.2 5.11-2.66 0-4.8-1.97-4.8-4.77 0-2.9 2.32-4.86 5.2-4.72v2.52c-.36-.06-.74-.06-1.1.02-1.1.24-1.86 1.1-1.76 2.3.1 1.1 1 1.9 2.1 1.86 1.24-.04 2.06-.99 2.06-2.4V3h2.5z" />
    </svg>
  )
}
 ...
 * Seasons "on the water today" strip and the sticky-header weather widget.
 */
