...
const data = SPECIES_PAGES['winter-steelhead']

export const Route = createFileRoute('/winter-steelhead')({
  ...
  head: () => ({
    ...
    links: [
      {
        rel: 'canonical',
        href: 'https://www.catchingchromeguideservice.com/winter-steelhead',
      },
    ],
  }),
})
